...
import UI.Model.CustomLabel;
import UI.Model.DeckUI;
import UI.Model.DominionImageButton;
import UI.Model.FloatingCard;
import UI.Model.HiddenDeckUI;
import Model.Board;
import Model.Card;
...
public class DominionUI extends Game implements Screen{
	...
	public void create() {
		...
		Gdx.graphics.setWindowedMode((int)UIConfig.width, (int)UIConfig.height);
		stage = new Stage();
